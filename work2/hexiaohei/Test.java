...
public class Test {
    public static void main(String[] args) {
        //有哪些动物
        Animal animal1 = new Cat("喵喵",2, "雌", 300, true);
        Animal animal2 = new ChineseRuralDog("笨柴", 2, "雄", 200, true);
        Animal animal3 = new Hamster("绿豆", 1, "雌", 160, true);
        Animal animal4 = new Hamster("黄豆", 1, "雄", 160, true);
        Animal animal5 = new Hamster("红豆", 1, "雌", 160, true);
        Animal animal6 = new Hamster("黑豆", 1, "雄", 160, true);
        Animal animal7 = new Cat("嘻嘻",2, "雌", 300, true);
        Animal animal8 = new Cat("哈哈",2, "雄", 300, true);
        Animal animal9 = new ChineseRuralDog("蹦蹦", 2, "雄", 200, true);
